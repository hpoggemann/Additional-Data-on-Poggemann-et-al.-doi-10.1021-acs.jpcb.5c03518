...
data_file = "data.Aae500_qeq"
# Import the molecule file (h, oh, h2o2, no, o, o2)
mol_file = "oh.mol"
...
pair_coeff      * * protein2013.ff H C N O S X X 
...
dump_modify     traj append yes element H C N O S Mg Fe 
"""'''
# Run sasa
